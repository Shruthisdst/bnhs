...
<head>
	...
	<link rel="shortcut icon" href="img/aplogo.ico">
	...
	<title>Bombay Natural History Society</title>
</head>
<body>
	<header class="cd-header">
		...
		<nav class="cd-main-nav">
			<ul>
				...
				<li><a href="volumes.php">Archive</a> | <a href="volumes.php">Volumes</a></li>
				<li><a href="#">Help</a></li>
			</ul>
		</nav> <!-- cd-main-nav -->
		...
		<div id="cd-sec-nav">
			...
			<nav id="cd-sec-main-nav">
				<ul>
					<li><a href="volumes.php"><i class="fa fa-calendar"></i> Volumes</a></li>
